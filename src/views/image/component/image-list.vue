<template>
  <div>
    <div class="action-head">
      ...
      <el-button class="addI" type="success" size="small" @click="dialogUploadVisible = true" v-if="isShow">添加图片</el-button>
    </div>
    <el-row :gutter="20">
        <el-col
          :lg="4"
        ...
        >
          ...
          <div class="yesimg" v-if="!isShow && selected === index"></div>
          <div class="imgbtn" v-if="isShow">
            <el-button
              type="warning"
